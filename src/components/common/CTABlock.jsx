...
export default function CTABlock({
  ...
  return (
    <div className="bg-gradient-to-br from-[#284061] to-[#1a2d47] rounded-3xl p-10 lg:p-16 text-center relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          <button onClick={onPrimary} className="inline-flex items-center gap-2 bg-gradient-to-br from-amber-500 to-amber-600 text-white px-7 py-3.5 rounded-xl text-sm font-semibold shadow-xl shadow-amber-500/30 hover:shadow-2xl hover:shadow-amber-500/40 hover:-translate-y-0.5 transition-all hover:cursor-pointer">
