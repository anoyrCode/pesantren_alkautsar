        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <Reveal direction="left">
            <div className="relative">
              <div className="bg-gradient-to-br from-[#284061] to-[#1a2d47] rounded-3xl p-8 lg:p-10 relative overflow-hidden">
                <div className="absolute -top-20 -right-20 w-80 h-80 rounded-full" style={{ background: "radial-gradient(circle,rgba(192,155,90,.15) 0%,transparent 65%)" }} />
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 relative z-10">
                  {[["901", "Santri Aktif"], ["6th", "Masa Studi"], ["110", "CCTV"], ["1:10", "Musyrif"]].map(([n, l]) => (
                    <div key={n} className="bg-white/[.06] border border-white/[.08] rounded-xl p-3.5 text-center hover:bg-amber-500/15 transition-all">
              ...
              <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl px-5 py-3.5 shadow-2xl border border-slate-100 flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#284061] to-[#1a2d47] flex items-center justify-center text-white">
                  <School size={18} />
                </div>
            ...
            <ul className="space-y-2.5">
              {POINTS.map(([Icon, tx]) => (
                <li key={tx} className="group flex items-start gap-3 p-3.5 rounded-xl border border-slate-100 bg-slate-50 hover:bg-white hover:shadow-md hover:translate-x-1 transition-all">
                  <div className="w-8 h-8 flex-shrink-0 rounded-lg bg-gradient-to-br from-[#284061] to-[#1a2d47] flex items-center justify-center text-white group-hover:scale-110 transition-transform">
                    <Icon size={14} />
                  </div>
